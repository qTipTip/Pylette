...
def main():
    ...
    parser.add_argument('--mode', help='extraction_mode (KMeans/MedianCut', type=str,
                        default='KM', choices=['KM', 'MC'])
    ...
    parser.add_argument('--stdout', help='whether to display the extracted color values in the stdout', type=bool,
                        default=True)
    parser.add_argument('--colorspace', help='color space to represent colors in', default='RGB', type=str,
                        choices=['rgb', 'hsv', 'hls'])
    parser.add_argument('--out_filename', help='where to save the csv file', default=None, type=str)
    parser.add_argument('--display-colors', help='Open a window displaying the extracted palette', default=False,
                        type=bool)
